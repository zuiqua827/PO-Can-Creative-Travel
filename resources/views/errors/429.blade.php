...
<div class="min-h-[70vh] flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full text-center space-y-6 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-slate-100">
        ...
        <div class="pt-2 flex flex-col sm:flex-row gap-3">
            <a href="javascript:location.reload()" class="inline-flex items-center justify-center flex-1 py-3 px-5 rounded-2xl bg-brand-600 hover:bg-brand-700 text-white font-bold text-sm transition shadow-md">
                Muat Ulang
            </a>
            <a href="{{ route('home') }}" class="inline-flex items-center justify-center flex-1 py-3 px-5 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm transition shadow-md">
                Ke Beranda
            </a>
        </div>
    </div>
