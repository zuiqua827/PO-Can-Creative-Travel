...
@section('title', '419 - Sesi Berakhir - PO CAN Travel')
    ...
    <div class="max-w-md w-full text-center space-y-6 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-slate-100">
        ...
        <div>
            ...
            <p class="mt-2 text-xs sm:text-sm text-slate-500 leading-relaxed">
                Halaman telah kedaluwarsa karena tidak ada aktivitas dalam waktu lama. Silakan muat ulang halaman atau login kembali.
            </p>
        </div>
        <div class="pt-2">
            <a href="{{ route('login') }}" class="inline-flex items-center justify-center w-full py-3.5 px-5 rounded-2xl bg-slate-900 hover:bg-brand-600 text-white font-bold text-sm transition shadow-md">
                Masuk Kembali
            </a>
        </div>
    </div>
